...
Users can define an environmental variable `CMAPS_FILE_DIR` pointing to the folder containing the self-defined RGB colormaps. The complete colormap pictures can be found under `colormaps` directory.
